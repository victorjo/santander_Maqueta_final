    ...
    function h(b) {
        ...
        if (f) {
            ...
            d.slideDown("fast",function(){
				...
				console.log("se descargo el slideDown") 
    ...
    b.init = function (b) {
        ...
        return this.each(function () {
            ...
            if (!f) {
                var i = [],
                    j = b.data;
                c.find("option").each(function (i) {
                
                	console.log("slick num"+i);
                    var b = a(this),
                        c = b.data();
                    i.push({
                        text: a.trim(b.text()),
