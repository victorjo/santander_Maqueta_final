...
function bannerChange(index){
	if(index==0){
		$(".w10_IT_wraRight").css({"background-image":"url('widgets/max/w_13/img/wra_Right.png')"});
		}
	else if(index==1){
		$(".w10_IT_wraRight").css({"background-image":"url('widgets/max/w_13/img/wra_Right2.jpg')"});
		}
	else if(index==2){
		$(".w10_IT_wraRight").css({"background-image":"url('widgets/max/w_13/img/wra_Right3.jpg')"});
		}
}

function miniBannerChange(index){
	if(index==0){
		$(".w10_HPG_miniBanner").css({"background-image":"url('widgets/max/w_13/img/tit_Programa_1.png')"});
		}
	else if(index==1){
		$(".w10_HPG_miniBanner").css({"background-image":"url('widgets/max/w_13/img/tit_Programa_2.jpg')"});
		}
	else if(index==2){
		$(".w10_HPG_miniBanner").css({"background-image":"url('widgets/max/w_13/img/tit_Programa_3.jpg')"});
		}
}
